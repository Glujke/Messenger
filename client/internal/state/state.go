...
func New(a fyne.App, w fyne.Window, apiURL string, encryptionKey string) *AppState {
	return &AppState{
		API:       api.New(apiURL),
...
// SetContacts updates the contact list and triggers callback.
...
// SetContactRequests updates the contact requests list and triggers callback.
...
// SetMessages updates the message list, decrypts them, and triggers callback.
...
// AddMessage adds a single message, decrypts it, and triggers callback.
